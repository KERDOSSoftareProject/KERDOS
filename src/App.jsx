  ...
  return (
    <div style={{fontFamily:"'Inter',-apple-system,sans-serif",minHeight:"100vh",background:"#003584"}}>
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"12px 12px 80px"}}>
        ...
        {tab==="home"&&(
          <div>
            <div style={{textAlign:"center",padding:"64px 16px 40px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"48vh"}}>
              {logoUrl?(
                <img src={logoUrl} alt={org.name} style={{maxHeight:140,maxWidth:340,objectFit:"contain",marginBottom:28}} />
              ):org.role==="owner"?(
                <label style={{display:"inline-flex",flexDirection:"column",alignItems:"center",cursor:"pointer",padding:"20px 28px",borderRadius:16,border:"2px dashed rgba(255,255,255,0.3)",marginBottom:28}}>
                  <span style={{fontSize:88}}>🦉</span>
                  <span style={{fontSize:12,color:"rgba(255,255,255,0.6)",marginTop:10}}>{logoUploading?"Uploading...":"+ Add your logo"}</span>
              ...
              <div style={{color:"white",fontWeight:900,fontSize:26,marginBottom:8}}>{getGreeting()}, {org.name}</div>
              <div style={{color:"rgba(255,255,255,0.7)",fontSize:14,marginBottom:30}}>Here's what you can do today.</div>
