  ...
  return (
    <div style={{minHeight:"100vh",background:"#003584",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,textAlign:"center"}}>
      ...
      <div style={{fontSize:16,color:"rgba(255,255,255,0.85)",marginBottom:40,maxWidth:440,lineHeight:1.5}}>
        Procurement made simple. Compare vendor prices, place smarter orders, and keep every invoice organized — all in one place.
      </div>
        ...
        {tab==="home"&&(
          <div>
            <div style={{textAlign:"center",padding:"40px 16px 28px"}}>
              {logoUrl?(
                <img src={logoUrl} alt={org.name} style={{maxHeight:72,maxWidth:260,objectFit:"contain",marginBottom:18}} />
              ):org.role==="owner"?(
                <label style={{display:"inline-flex",flexDirection:"column",alignItems:"center",cursor:"pointer",padding:"14px 20px",borderRadius:12,border:"2px dashed rgba(255,255,255,0.3)",marginBottom:18}}>
                  <span style={{fontSize:34}}>🦉</span>
                  <span style={{fontSize:12,color:"rgba(255,255,255,0.6)",marginTop:8}}>{logoUploading?"Uploading...":"+ Add your logo"}</span>
              ...
              <div style={{color:"white",fontWeight:900,fontSize:24,marginBottom:6}}>{getGreeting()}, {org.name}</div>
              <div style={{color:"rgba(255,255,255,0.7)",fontSize:14,marginBottom:26}}>Here's what you can do today.</div>
              <button onClick={()=>setTab("order")}
                style={{...btn("white","#003584",{padding:"16px 44px",fontSize:16,borderRadius:10,fontWeight:800}),boxShadow:"0 4px 14px rgba(0,0,0,0.2)"}}>
                Get Started →
              </button>
            </div>

            <div style={{fontSize:11,fontWeight:700,color:"rgba(255,255,255,0.6)",letterSpacing:"0.08em",textTransform:"uppercase",textAlign:"center",marginBottom:14}}>Quick actions</div>
            <div style={{display:"flex",gap:14,flexWrap:"wrap",justifyContent:"center"}}>
              {org.role!=="employee"&&(
                <div onClick={()=>{setSelectedVendorId(null);setImportMode("pricelist");setTab("import");}} style={{cursor:"pointer",background:"white",borderRadius:14,padding:"24px 22px",width:210,textAlign:"center",boxShadow:"0 1px 4px rgba(0,0,0,0.08)",border:"1px solid #EEE"}}>
              ...
              <div onClick={()=>{setSelectedVendorId(null);setImportMode("invoice");setTab("invoices");}} style={{cursor:"pointer",background:"white",borderRadius:14,padding:"24px 22px",width:210,textAlign:"center",boxShadow:"0 1px 4px rgba(0,0,0,0.08)",border:"1px solid #EEE"}}>
                <div style={{fontSize:30,marginBottom:8}}>🧾</div>
              ...
              {(org.role==="owner"||org.role==="manager")&&(
                <div onClick={()=>setTab("team")} style={{cursor:"pointer",background:"white",borderRadius:14,padding:"24px 22px",width:210,textAlign:"center",boxShadow:"0 1px 4px rgba(0,0,0,0.08)",border:"1px solid #EEE"}}>
                  <div style={{fontSize:30,marginBottom:8}}>👥</div>
            ...
            {vendors.length>0&&(
              <div style={{marginTop:32,textAlign:"center"}}>
                <div style={{fontSize:11,fontWeight:700,color:"rgba(255,255,255,0.65)",letterSpacing:"0.06em",textTransform:"uppercase",marginBottom:10}}>Your Vendors — tap for details</div>
