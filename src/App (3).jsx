...
// ── KERDOS MARK ──────────────────────────────────────────────────────
// The coin logo: an owl-drachma, in the spirit of the ancient Athenian
// "owl" coins. Used across login, setup, loading, and header.
function KerdosMark({ size = 40 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" style={{flexShrink:0}}>
      <circle cx="100" cy="100" r="90" fill="#C9A227" stroke="#8A6B14" strokeWidth="3"/>
      <circle cx="100" cy="100" r="76" fill="#E4C158" stroke="#8A6B14" strokeWidth="1"/>
      <g transform="translate(100,104)">
        <ellipse cx="0" cy="8" rx="34" ry="38" fill="#3B2A12"/>
        <path d="M -34 -8 L -46 -30 L -20 -20 Z" fill="#3B2A12"/>
        <path d="M 34 -8 L 46 -30 L 20 -20 Z" fill="#3B2A12"/>
        <circle cx="-14" cy="0" r="13" fill="#E4C158"/>
        <circle cx="14" cy="0" r="13" fill="#E4C158"/>
        <circle cx="-14" cy="0" r="6" fill="#3B2A12"/>
        <circle cx="14" cy="0" r="6" fill="#3B2A12"/>
        <path d="M 0 6 L -6 16 L 6 16 Z" fill="#3B2A12"/>
        <path d="M -20 30 Q 0 42 20 30 Q 0 46 -20 30 Z" fill="#8A6B14"/>
      </g>
    </svg>
  );
}
