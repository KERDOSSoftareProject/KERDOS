...
// ── KERDOS MARK ──────────────────────────────────────────────────────
// The coin logo: an owl-drachma, modeled on the real Greek 1-drachma
// coin — full standing owl body, feathered eye rings, stippled
// texture — used across login, setup, loading, and header.
function KerdosMark({ size = 40 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" style={{flexShrink:0}}>
      <circle cx="100" cy="100" r="92" fill="#A9682F" stroke="#6B3F17" strokeWidth="3"/>
      <circle cx="100" cy="100" r="78" fill="#C3814A" stroke="#6B3F17" strokeWidth="1"/>
      <g transform="translate(78,104)">
        <line x1="-9" y1="46" x2="-12" y2="58" stroke="#5A3416" strokeWidth="3" strokeLinecap="round"/>
        <line x1="7" y1="46" x2="10" y2="58" stroke="#5A3416" strokeWidth="3" strokeLinecap="round"/>
        <line x1="-16" y1="58" x2="-8" y2="58" stroke="#5A3416" strokeWidth="2.5" strokeLinecap="round"/>
        <line x1="4" y1="58" x2="14" y2="58" stroke="#5A3416" strokeWidth="2.5" strokeLinecap="round"/>
        <ellipse cx="0" cy="8" rx="30" ry="40" fill="#5A3416"/>
        <g fill="#C3814A" opacity="0.9">
          <circle cx="-14" cy="-4" r="1.8"/><circle cx="-2" cy="-6" r="1.8"/><circle cx="10" cy="-3" r="1.8"/>
          <circle cx="-18" cy="6" r="1.8"/><circle cx="-6" cy="5" r="1.8"/><circle cx="6" cy="7" r="1.8"/><circle cx="17" cy="5" r="1.8"/>
          <circle cx="-15" cy="17" r="1.8"/><circle cx="-3" cy="18" r="1.8"/><circle cx="9" cy="17" r="1.8"/>
          <circle cx="-19" cy="28" r="1.8"/><circle cx="-8" cy="30" r="1.8"/><circle cx="4" cy="30" r="1.8"/><circle cx="16" cy="27" r="1.8"/>
          <circle cx="-12" cy="39" r="1.8"/><circle cx="0" cy="40" r="1.8"/><circle cx="12" cy="38" r="1.8"/>
        </g>
        <path d="M -26 -30 Q -30 -44 -18 -42 Q -22 -34 -14 -30 Z" fill="#5A3416"/>
        <path d="M 26 -30 Q 30 -44 18 -42 Q 22 -34 14 -30 Z" fill="#5A3416"/>
        <circle cx="-13" cy="-16" r="17" fill="#5A3416"/>
        <circle cx="13" cy="-16" r="17" fill="#5A3416"/>
        <circle cx="-13" cy="-16" r="12" fill="#C3814A"/>
        <circle cx="13" cy="-16" r="12" fill="#C3814A"/>
        <circle cx="-13" cy="-16" r="6" fill="#5A3416"/>
        <circle cx="13" cy="-16" r="6" fill="#5A3416"/>
        <path d="M 0 -4 L -5 4 L 5 4 Z" fill="#5A3416"/>
      </g>
    </svg>
  );
}
